...
const DEFAULT_WIDGETS: DashWidget[] = [
  ...
  { id: 'race-forecast',    label: 'Race Day Forecast',         icon: 'WX', zone: 'now',      enabled: true,  pro: false },
  { id: 'race-prediction',  label: 'Race Prediction',           icon: 'PRD', zone: 'now',     enabled: false, pro: false },
  ...
  { id: 'weather-fit',      label: 'Weather Fit Score',         icon: 'WX', zone: 'now',      enabled: false, pro: false },
  { id: 'race-stack',       label: 'Race Stack Planner',        icon: 'STK', zone: 'now',     enabled: false, pro: false },
  ...
  { id: 'break-tape',       label: 'Break Tape Moments',        icon: 'BT', zone: 'recently', enabled: false, pro: false },
  // CONSISTENCY — BUILD
  ...
  { id: 'advanced-race-dna',label: 'Advanced Race DNA',         icon: 'DNA', zone: 'context', enabled: false, pro: false },
  { id: 'race-comparer',    label: 'Race Comparer',             icon: 'CMP', zone: 'context', enabled: false, pro: false },
  { id: 'what-to-race-next',label: 'What To Race Next',         icon: 'WTR', zone: 'context', enabled: false, pro: false },
  { id: 'story-mode',       label: 'Story Mode',                icon: 'STY', zone: 'recently',enabled: true,  pro: false },
  { id: 'coach-activity',   label: 'Coach Activity',            icon: 'CCH', zone: 'context', enabled: false, pro: false },
