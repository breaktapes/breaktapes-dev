...
-- ────────────────────────────────────────────────────────────
-- 2. Change user_id column types uuid → text
-- ────────────────────────────────────────────────────────────
ALTER TABLE public.user_state
...
-- ────────────────────────────────────────────────────────────
-- 3. Drop old auth.uid() RLS policies
-- ────────────────────────────────────────────────────────────
...
-- ────────────────────────────────────────────────────────────
-- 4. Recreate RLS policies using Clerk JWT sub claim
-- ────────────────────────────────────────────────────────────
...
-- ────────────────────────────────────────────────────────────
-- 5. Wipe existing rows — old Supabase UUID user IDs are
